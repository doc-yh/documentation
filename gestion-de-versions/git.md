...
Voici un exemple de convention de nommage pour les commit sur Git :

* "WIP" (Work in Progress) pour les commits en cours de travail (WIP: Implement new feature)
* "Feat" pour les nouvelles fonctionnalités (Feat: Add support for file uploads)
* "Fix" pour les corrections de bugs (Fix: Fix bug in login form)
* "Chore" pour les tâches de maintenance ou d'organisation (Chore: Update dependencies)
* "Docs" pour les modifications de la documentation (Docs: Add documentation for new API endpoint)
